...
public class AlgorithmRSA {
     ...
     */
    public synchronized String encrypt(String message,BigInteger d,BigInteger n) {
     ...
     * Encrypt the given plaintext message.
     */
    public synchronized BigInteger encrypt(BigInteger message,BigInteger d,BigInteger n) {
     ...
     */
    public synchronized String decrypt(String message,BigInteger e,BigInteger n) {
